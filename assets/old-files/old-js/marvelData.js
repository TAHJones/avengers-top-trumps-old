...
heroName; /*global heroName*/
console.log(heroName);

superheroName; /*global superheroName*/

/*var marvelHero = function getMarvelHero(){
    switch(heroName) { // match infinity stone name with counter score number
      case "":
      case 0:
      case "0":
      case null:
